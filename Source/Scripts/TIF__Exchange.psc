...
Scriptname TIF__Exchange Extends TopicInfo Hidden

;BEGIN FRAGMENT Fragment_0
Function Fragment_0(ObjectReference akSpeakerRef)
Actor akSpeaker = akSpeakerRef as Actor
;BEGIN CODE
(DES_CurrencyFramework as DES_CurrencyFramework_Functions).ExchangeCoins(oldcoin, count, newcoin, coinworth, divide)
;END CODE
EndFunction
;END FRAGMENT
