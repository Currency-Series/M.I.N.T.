...
;BEGIN ALIAS PROPERTY DecreeMarker
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_DecreeMarker Auto
;END ALIAS PROPERTY
...
;BEGIN CODE
Alias_DecreeMarker.GetRef().Disable()
Alias_DecreeMarker.GetRef().Delete()
Alias_DecreeMarker.trytoClear()
